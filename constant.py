...
3. Generate Descriptive Topic Titles: For each identified segment, create a concise and compelling topic title in the specified {{language}}}. These titles should be designed to attract viewers and give them a clear idea of the segment's content. Focus on evocative language and avoid generic descriptions.

Output JSON Format: Return the segmented data in a JSON format as follows:
[
  {
    "topic": "Engaging Topic Title in {{language}}",
    "start_timestamp": "00:01:30",  // Example: HH:MM:SS
    "end_timestamp": "00:01:45"    // Example: HH:MM:SS
  },
  {
    "topic": "Another Captivating Title in {{language}}",
